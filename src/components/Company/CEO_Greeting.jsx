            ...
            <GreetingDescription>
                <div>
                    ...
                    <div style={{display: "flex", height:"5rem", alignItems:"center", justifyContent:"center"}}>
                        <GmarketMedium fontColor={PRIMARY_COLOR} fontSize={"1.5rem"}>블록체인이 세상을 바꾼다</GmarketMedium>
                        <GmarketMedium fontColor={GREY_FONT_COLOR} fontSize={"1rem"}>저자</GmarketMedium>
                        <GmarketBold fontColor={PRIMARY_COLOR} fontSize={"1.5rem"} fontWeight={"bold"}>김종현</GmarketBold>
                    </div>
                </div>
                <div style={{width:"30%"}}>
                    <GmarketMedium fontColor={GREY_FONT_COLOR} fontSize={"2.3rem"}>"인터넷이 온라인 세상에서 우리를 연결해주었다면,</GmarketMedium>
                    <GmarketMedium fontColor={GREY_FONT_COLOR} fontSize={"2.3rem"}>블록체인은 중간 매개자 없이 개인간 직접 거래가 가능하도록 신뢰를 제공하며 세상을 바꿔주고 있다.</GmarketMedium>
                    <NoteSansMedium fontColor={GREY_FONT_COLOR} fontSize={"1rem"}>
