        ...
        <DescriptionContainer>
            <Description1>
                <div style={{width:"30rem", textAlign:"right"}}>
                    <GmarketMedium fontColor={GREY_FONT_COLOR} fontSize={"2.4rem"} >블록체인 서비스를 보다 쉽게,</GmarketMedium>
                    <GmarketMedium fontColor={GREY_FONT_COLOR} fontSize={"2.4rem"} >BaaS</GmarketMedium>
                ...
                <div style={{position:"relative", width:"70%", height: "100%"}}>
                    ...
                    <GmarketMedium styles={{position: "absolute", bottom: 0, opacity: 0.1, right:0}} fontColor={WHITE_FONT_COLOR} fontWeight={"bold"} fontSize={"18.75rem"}>BaaS</GmarketMedium>
                </div>
            </Description1>
            <Description2>
                <div style={{position:"relative", width:"70%", height: "100%"}}>
                    <img style={{ width: "100%", height: "100%", objectFit: "cover",float:"right"}}  src="/images/service_description2.png" alt="서비스 설명 2"/>
                    <GmarketMedium styles={{position: "absolute", top:100, opacity: 0.1, left:100}} fontColor={WHITE_FONT_COLOR} fontWeight={"bold"} fontSize={"18.75rem"}>API</GmarketMedium>
                </div>
                <div style={{width:"30rem", textAlign:"left"}}>
                    <GmarketMedium fontColor={GREY_FONT_COLOR} fontSize={"2.4rem"} >개발자를 위한 API 서비스</GmarketMedium>
                    <NoteSansMedium fontColor={GREY_FONT_COLOR} fontSize={"1.2rem"} >
