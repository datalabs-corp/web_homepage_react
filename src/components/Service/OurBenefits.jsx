...
const items = [
  {
    image:
      "https://res.cloudinary.com/dz7lhzjdh/image/upload/v1648086085/images/time_qgnltf.png",
    title: "개발 시간 단축",
    description: ["노드를 직접 운영하지 않아 온전한 개발에 집중"],
  },
  {
    image:
      "https://res.cloudinary.com/dz7lhzjdh/image/upload/v1648086085/images/gear_lbgvaj.png",
    title: "편의성",
    description: [
  ...
  {
    image:
      "https://res.cloudinary.com/dz7lhzjdh/image/upload/v1648086085/images/lock_b66nik.png",
    title: "계정 키 관리",
    description: [
  ...
  {
    image:
      "https://res.cloudinary.com/dz7lhzjdh/image/upload/v1648086085/images/won_aco6l5.png",
    title: "비용 절약",
    description: [
...
const BenefitsItem = ({ image, title, description }) => {
  return (
    <Item>
      ...
      <GmarketMedium
        styles={{ marginTop: "1vw", marginBottom: "1vw" }}
